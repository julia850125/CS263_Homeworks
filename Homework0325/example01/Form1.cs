...
namespace Example01
{
    public partial class Form1 : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            {
                employee = new Manager(idTextBox.Text, nameTextBox.Text, baseSalaryTextBox.Text, DepartmentPerformancetextBox.Text);
            }
        ...
        private void UpdateEmployeesInfo()
        {
            ...
            DepartmentPerformancetextBox.Text= string.Empty;
        ...
        private void employeeCatagory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DepartmentPerformanceLabel.Visible = employeeCatagory.SelectedIndex == 2;
            DepartmentPerformancetextBox.Visible = employeeCatagory.SelectedIndex == 2;
